...
def default_generators():
    return pd.DataFrame([
        {"name": "Gen 1 at Bus 2", "bus_id": "B2", "p_mw": 120.0, "vm_pu": 1.00, "min_q_mvar": -20.0, "max_q_mvar": 40.0},
        {"name": "Local Gen at Bus 5", "bus_id": "B5", "p_mw": 35.0, "vm_pu": 1.00, "min_q_mvar": -10.0, "max_q_mvar": 15.0},
        {"name": "Gen 2 at Bus 7", "bus_id": "B7", "p_mw": 45.0, "vm_pu": 1.00, "min_q_mvar": -15.0, "max_q_mvar": 25.0},
    ])
...
def default_lines():
    return pd.DataFrame([
        ...
        {"name": "Line 3-5 Tie", "from_bus_id": "B3", "to_bus_id": "B5", "length_km": 80.0, "r_ohm_per_km": 0.12, "x_ohm_per_km": 0.55, "c_nf_per_km": 12.0, "max_i_ka": 0.25, "in_service": True},
...
def default_base_cases():
    return pd.DataFrame([
        {"case_name": "summer_peak", "load_scale": 1.00, "Gen 1 at Bus 2": 120.0, "Local Gen at Bus 5": 35.0, "Gen 2 at Bus 7": 45.0},
        {"case_name": "future_peak", "load_scale": 1.20, "Gen 1 at Bus 2": 120.0, "Local Gen at Bus 5": 35.0, "Gen 2 at Bus 7": 45.0},
        {"case_name": "light_load", "load_scale": 0.40, "Gen 1 at Bus 2": 80.0, "Local Gen at Bus 5": 20.0, "Gen 2 at Bus 7": 25.0},
        {"case_name": "local_gen_off", "load_scale": 1.00, "Gen 1 at Bus 2": 120.0, "Local Gen at Bus 5": 0.0, "Gen 2 at Bus 7": 0.0},
    ])
