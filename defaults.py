...
def default_generators():
    return pd.DataFrame([
        {"name": "Gen 1 at Bus G2", "bus_id": "G2", "p_mw": 120.0, "vm_pu": 1.00, "min_q_mvar": -20.0, "max_q_mvar": 40.0},
        {"name": "Local Gen at Bus G5", "bus_id": "G5", "p_mw": 35.0, "vm_pu": 1.00, "min_q_mvar": -10.0, "max_q_mvar": 15.0},
        {"name": "Gen 2 at Bus G7", "bus_id": "G7", "p_mw": 45.0, "vm_pu": 1.00, "min_q_mvar": -15.0, "max_q_mvar": 25.0},
    ])
...
def default_transformers():
    return pd.DataFrame([
        ...
        {"name": "Transformer 3-4", "hv_bus_id": "B3", "lv_bus_id": "B4", "sn_mva": 120.0, "vn_hv_kv": 230.0, "vn_lv_kv": 115.0, "vk_percent": 10.0, "vkr_percent": 0.5, "pfe_kw": 0.0, "i0_percent": 0.0, "in_service": True},
        {"name": "Transformer 2-6", "hv_bus_id": "B2", "lv_bus_id": "B6", "sn_mva": 100.0, "vn_hv_kv": 230.0, "vn_lv_kv": 115.0, "vk_percent": 10.5, "vkr_percent": 0.6, "pfe_kw": 0.0, "i0_percent": 0.0, "in_service": True},
        {"name": "Transformer 1-7", "hv_bus_id": "B1", "lv_bus_id": "B7", "sn_mva": 90.0, "vn_hv_kv": 230.0, "vn_lv_kv": 115.0, "vk_percent": 11.0, "vkr_percent": 0.7, "pfe_kw": 0.0, "i0_percent": 0.0, "in_service": True},

        # Generator step-up transformers
        {"name": "GSU Transformer G2-2", "hv_bus_id": "B2", "lv_bus_id": "G2", "sn_mva": 150.0, "vn_hv_kv": 230.0, "vn_lv_kv": 12.5, "vk_percent": 12.0, "vkr_percent": 0.5, "pfe_kw": 0.0, "i0_percent": 0.0, "in_service": True},
        {"name": "GSU Transformer G5-5", "hv_bus_id": "B5", "lv_bus_id": "G5", "sn_mva": 50.0, "vn_hv_kv": 115.0, "vn_lv_kv": 12.5, "vk_percent": 10.0, "vkr_percent": 0.6, "pfe_kw": 0.0, "i0_percent": 0.0, "in_service": True},
        {"name": "GSU Transformer G7-7", "hv_bus_id": "B7", "lv_bus_id": "G7", "sn_mva": 65.0, "vn_hv_kv": 115.0, "vn_lv_kv": 12.5, "vk_percent": 10.0, "vkr_percent": 0.6, "pfe_kw": 0.0, "i0_percent": 0.0, "in_service": True},
    ])


def default_base_cases():
    return pd.DataFrame([
        {"case_name": "summer_peak", "load_scale": 1.00, "Gen 1 at Bus G2": 120.0, "Local Gen at Bus G5": 35.0, "Gen 2 at Bus G7": 45.0},
        {"case_name": "future_peak", "load_scale": 1.20, "Gen 1 at Bus G2": 120.0, "Local Gen at Bus G5": 35.0, "Gen 2 at Bus G7": 45.0},
        {"case_name": "light_load", "load_scale": 0.40, "Gen 1 at Bus G2": 80.0, "Local Gen at Bus G5": 20.0, "Gen 2 at Bus G7": 25.0},
        {"case_name": "local_gen_off", "load_scale": 1.00, "Gen 1 at Bus G2": 120.0, "Local Gen at Bus G5": 0.0, "Gen 2 at Bus G7": 0.0},
    ])
